  ...
  if (targetName) {
    ...
    if (pagePerSection) {
      ...
      hashArray.forEach(function (hashName, index) {
        ...
        filteredSections = filterComponentsInSectionsByExactName(sections, hashName, false); // If filteredSections exists, its because is an array of an component
    ...
    if (isFinite(targetIndex)) {
      if (filteredSections.length === 1) {
        ...
        sections = [_objectSpread({}, filteredSections[0], {
