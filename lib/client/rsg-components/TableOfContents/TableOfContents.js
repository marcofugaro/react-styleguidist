  ...
  _createClass(TableOfContents, [{
    ...
    value: function renderLevel(sections) {
      ...
      var items = sections.map(function (section) {
        var children = _toConsumableArray(section.sections || []).concat(_toConsumableArray(section.components || []));

        var sectionDepth = section.sectionDepth || 0;
        var childHashPath = sectionDepth === 0 && useHashId ? hashPath : _toConsumableArray(hashPath).concat([section.name]);
