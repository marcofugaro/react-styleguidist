 ...
 */
function evalInContext(header, require, code) {
...
{${code}}`; // eslint-disable-next-line no-new-func
  ...
  const func = new Function('require', 'state', 'setState', body); // Bind the `require` function, other context arguments will be passed from
  // the frontend
  // $FlowFixMe
